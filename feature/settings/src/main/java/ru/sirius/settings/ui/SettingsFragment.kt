...
import ru.sirius.settings.databinding.FragmentSettingsBinding
import ru.sirius.settings.data.ID_DAILY_REMINDER
import ru.sirius.settings.data.ID_LANGUAGE
import ru.sirius.settings.data.ID_NOTIFICATION_PROGRESS
import ru.sirius.settings.data.ID_THEME
import ru.sirius.settings.data.ID_TIME_REMINDER
import ru.sirius.settings.data.ID_VOICE
